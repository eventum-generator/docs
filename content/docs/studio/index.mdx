...
After an upgrade, Studio describes what the new version brought: a short set of panels, one change each, that opens on the first visit to the upgraded instance. The last panel links to the full changelog.

Each browser is shown the panels once. Afterwards they stay available from the user menu, under **What's new**, next to About. They need no internet access.
