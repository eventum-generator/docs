...
<Mermaid chart={`graph LR
    ...
    classDef upcoming fill:#9ca3af,color:#fff,stroke:#6b7280,stroke-width:2px,stroke-dasharray:5 5`} />
...
Understand the shape of your data — Windows events, CEF, LEEF, syslog, NDJSON, OCSF, ECS — and generate a compliant sample of each.
