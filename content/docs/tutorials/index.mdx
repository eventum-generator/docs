...
Understand the shape of your data — Windows events, CEF, LEEF, syslog, NDJSON, OCSF, ECS, Apache/Nginx access logs, AWS CloudTrail, Suricata EVE JSON — and generate a compliant sample of each.
