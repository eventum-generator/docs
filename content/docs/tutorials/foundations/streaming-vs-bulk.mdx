...
- The [IoT sensor telemetry](/docs/tutorials/iot-telemetry) tutorial for bounding a `timer` input with `repeat` to turn a live sensor stream into a finite dataset
