...
| **Password** | No | The password or access token of a private repository, either as the value itself or as a `${secrets.<name>}` [reference](/docs/core/config/secrets) read from the keyring. |
...
<Files>
  <Folder name="content-packs" defaultOpen>
    <Folder name="generators" defaultOpen>
      <Folder name="web-nginx" defaultOpen>
        <File name="generator.yml" />
        <File name="README.md" />
        <Folder name="templates" />
        <Folder name="samples" />
      </Folder>
      <Folder name="linux-auditd">
        <File name="generator.yml" />
        <File name="README.md" />
      </Folder>
    </Folder>
