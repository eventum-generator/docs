...
description: The formats your pipeline speaks — syslog, CEF, LEEF, Windows Event Log, NDJSON, OCSF, ECS, Apache/Nginx access logs — explained, with a generated sample of each.
---
