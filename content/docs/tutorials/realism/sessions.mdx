...
- The [Web Clickstream → ClickHouse](/docs/tutorials/web-clickstream) tutorial for the same technique applied to a five-state browsing session streamed into a real backend
