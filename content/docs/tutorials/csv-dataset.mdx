...
- The [Scenarios pillar](/docs/tutorials/scenarios) for the wider picture of applied synthetic data
- The [Eventum Hub](/hub) for ready-made generators instead of building a dataset from scratch
