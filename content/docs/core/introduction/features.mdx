...
<Screenshot
  lightSrc="/images/home/output_destinations_light.png"
  darkSrc="/images/home/output_destinations_dark.png"
  alt="A generator writing to four destinations, each with its own formatter"
/>
