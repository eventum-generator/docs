...
| `scenarios` | list of strings | `[]` | — | Scenario names this generator belongs to. Scenarios group generators for coordinated lifecycle control and shared global state visualization in [Studio](/docs/studio/scenarios). A generator can belong to multiple scenarios. |
