...
What the workspace already holds is marked beside the name of the generator: **installed**, or **update available** when the repository publishes it with content the installed project does not hold. The card names the projects it is installed as, each with whether it is still up to date and a link that opens it.
