...
- **Advancing a flow** — `module.rand.choice(open_ids)` picks which one at random, or `open_ids[0]` — the oldest entry — once the pool is full (see below). Its running byte total grows by a random chunk; once it has had three transfers, this render closes it and removes it from the pool instead of continuing it.
...
<Callout type="info">
The events below were produced by running this generator in [sample mode](/docs/core/concepts/generator#sample-mode) (`--live-mode false`) with a short bound added to the cron input, so forty events render at once for inspection. A generator left running normally drops that bound and lets cron tick indefinitely in [live mode](/docs/core/concepts/generator#live-mode-default) instead, opening and closing flows for as long as it runs.
</Callout>

## The result

Running this generator for forty timestamps opened fourteen flows, closed nine of them, and left five still transferring when the bound was reached — no two ever collided on an identifier, since each is a freshly generated UUID. A slice from early in the run shows three flows interleaved on one gateway before a fourth opens on another:

```json title="output/events.jsonl"
{"destination": {"ip": "192.0.1.150"}, "event": {"action": "flow_open", "sequence": 1}, "flow_id": "fbfc4b8a-ee77-4ed1-9fa1-af7c34f0b109", "host": {"name": "gw-eu-01"}, "network": {"bytes": 87}, "related": {"hosts": ["gw-eu-01"], "ip": ["10.197.112.141", "192.0.1.150"]}, "source": {"ip": "10.197.112.141"}, "timestamp": "2026-07-17T13:29:29+00:00"}
{"destination": {"ip": "194.49.119.185"}, "event": {"action": "flow_open", "sequence": 2}, "flow_id": "847c3644-5c79-45a1-811c-60163a398f7b", "host": {"name": "gw-eu-01"}, "network": {"bytes": 194}, "related": {"hosts": ["gw-eu-01"], "ip": ["10.152.222.217", "194.49.119.185"]}, "source": {"ip": "10.152.222.217"}, "timestamp": "2026-07-17T13:29:30+00:00"}
{"destination": {"ip": "194.49.119.185"}, "event": {"action": "flow_transfer", "sequence": 3}, "flow_id": "847c3644-5c79-45a1-811c-60163a398f7b", "host": {"name": "gw-eu-01"}, "network": {"bytes": 3077}, "related": {"hosts": ["gw-eu-01"], "ip": ["10.152.222.217", "194.49.119.185"]}, "source": {"ip": "10.152.222.217"}, "timestamp": "2026-07-17T13:29:31+00:00"}
{"destination": {"ip": "192.0.1.150"}, "event": {"action": "flow_transfer", "sequence": 4}, "flow_id": "fbfc4b8a-ee77-4ed1-9fa1-af7c34f0b109", "host": {"name": "gw-eu-01"}, "network": {"bytes": 3282}, "related": {"hosts": ["gw-eu-01"], "ip": ["10.197.112.141", "192.0.1.150"]}, "source": {"ip": "10.197.112.141"}, "timestamp": "2026-07-17T13:29:32+00:00"}
{"destination": {"ip": "175.217.177.181"}, "event": {"action": "flow_open", "sequence": 5}, "flow_id": "e315e18e-154d-4e6b-a4ab-978a3dac6b39", "host": {"name": "gw-eu-01"}, "network": {"bytes": 143}, "related": {"hosts": ["gw-eu-01"], "ip": ["10.200.117.207", "175.217.177.181"]}, "source": {"ip": "10.200.117.207"}, "timestamp": "2026-07-17T13:29:33+00:00"}
{"destination": {"ip": "192.0.1.150"}, "event": {"action": "flow_transfer", "sequence": 6}, "flow_id": "fbfc4b8a-ee77-4ed1-9fa1-af7c34f0b109", "host": {"name": "gw-eu-01"}, "network": {"bytes": 4686}, "related": {"hosts": ["gw-eu-01"], "ip": ["10.197.112.141", "192.0.1.150"]}, "source": {"ip": "10.197.112.141"}, "timestamp": "2026-07-17T13:29:34+00:00"}
{"destination": {"ip": "192.0.1.150"}, "event": {"action": "flow_close", "sequence": 7}, "flow_id": "fbfc4b8a-ee77-4ed1-9fa1-af7c34f0b109", "host": {"name": "gw-eu-01"}, "network": {"bytes": 5256}, "related": {"hosts": ["gw-eu-01"], "ip": ["10.197.112.141", "192.0.1.150"]}, "source": {"ip": "10.197.112.141"}, "timestamp": "2026-07-17T13:29:35+00:00"}
{"destination": {"ip": "175.217.177.181"}, "event": {"action": "flow_transfer", "sequence": 8}, "flow_id": "e315e18e-154d-4e6b-a4ab-978a3dac6b39", "host": {"name": "gw-eu-01"}, "network": {"bytes": 1967}, "related": {"hosts": ["gw-eu-01"], "ip": ["10.200.117.207", "175.217.177.181"]}, "source": {"ip": "10.200.117.207"}, "timestamp": "2026-07-17T13:29:36+00:00"}
{"destination": {"ip": "196.182.20.118"}, "event": {"action": "flow_open", "sequence": 1}, "flow_id": "e5d9fb17-c906-4d10-8ccd-66a65a25cb30", "host": {"name": "gw-us-01"}, "network": {"bytes": 185}, "related": {"hosts": ["gw-us-01"], "ip": ["10.132.53.176", "196.182.20.118"]}, "source": {"ip": "10.132.53.176"}, "timestamp": "2026-07-17T13:29:37+00:00"}
```

Three different `flow_id` values interleave across these lines, each opened, continued, or closed independently of the others, yet `event.sequence` for `gw-eu-01` still climbs 1, 2, 3, 4, 5, 6, 7, 8 without a gap or a repeat — the count belongs to the host, not to any one flow, so it keeps incrementing across every flow passing through that host. `gw-us-01` starts its own count at 1 the moment its first flow opens, entirely independent of whatever `gw-eu-01` has already reached.

Filtering the same run down to one `flow_id` shows the complete lifecycle a single connection went through, out of order in the file but tied together by the id every step repeats:
...
Every line carries `fbfc4b8a-ee77-4ed1-9fa1-af7c34f0b109`, `network.bytes` climbs from 87 to 5,256 as the running total grows at every step from open through close, and this host's `event.sequence` advances 1, 4, 6, 7 for this flow specifically — the gaps belong to other flows' events interleaved in between, not to anything missing from this one. Elsewhere in the same run, six flows were open across the three gateways at once at the busiest point — the pool's configured ceiling — and reaching it forced the oldest entry to close early rather than letting a seventh accumulate.
