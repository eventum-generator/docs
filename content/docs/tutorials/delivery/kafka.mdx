...
- The [scenarios track](/docs/tutorials/scenarios) for a complete stateful generator — the same finite-state, multi-template approach used there applies to a `kafka` output exactly as it does OpenSearch
