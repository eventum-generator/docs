...
<Cards>
  <Card title="Synthetic data for SIEM" description="Explore SIEM detection scenarios across Windows, Sysmon, network, and endpoint telemetry sources." href="/docs/tutorials/scenarios" />
  <Card title="SIEM test data: Windows → OpenSearch" description="Build a stateful Windows Security Event Log generator and index it into OpenSearch." href="/docs/tutorials/siem-events" />
