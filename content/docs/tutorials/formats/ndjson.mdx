---
title: "NDJSON format: newline-delimited JSON, JSON Lines, and how to generate it"
...
- The [formats field guide](/docs/tutorials/formats) covering Windows Event Log, CEF, LEEF, and syslog
