...
<Card title="Synthetic test data: use cases" description="Complete projects — pipeline testing, detection, load testing, database seeding, clickstream — built end to end and runnable as shipped." href="/docs/tutorials/scenarios" />
