...
| `repositories.yml` | Repositories of ready-made generators the instance is [connected to](/docs/studio/repositories). Written when the first one is connected — an instance that connects none never has it. |
