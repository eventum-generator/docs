...
<Cards>
  ...
  <Card title="OCSF" description="Open Cybersecurity Schema Framework: categories, event classes, and activities — and a generated compliant event." href="/docs/tutorials/formats/ocsf" />
  <Card title="ECS" description="Elastic Common Schema: how event, host, and related fields are namespaced, and a generated compliant event." href="/docs/tutorials/formats/ecs" />
</Cards>
