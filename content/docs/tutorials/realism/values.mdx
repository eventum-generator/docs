---
title: "Generate realistic values: skewed numbers and weighted choice"
...
## Skewed distributions for realistic numbers
...
## Weighted choice for realistic categories
...
- The [Realism](/docs/tutorials/realism) pillar for the other two axes that make synthetic data behave like production
