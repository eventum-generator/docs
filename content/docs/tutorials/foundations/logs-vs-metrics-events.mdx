...
Every row also starts with the same word, timestamped — a hint that logs, metrics, and events aren't different data sources, just different renderings of the same underlying record.
