...
<Cards>
  ...
  <Card title="Streaming vs bulk" description="Continuous streaming vs finite bulk output, and the flag that switches Eventum between them." href="/docs/tutorials/foundations/streaming-vs-bulk" />
</Cards>
